    ...
    return (
        <>
         <Head>
            ...
            <meta name="description" content={`Privacy Policy for ${process.env.WEBSITE_NAME}`} />
        </Head>
            <div className="container m-auto p-2 box-border text-lg">
                <div>
                    <h2 className='text-xl font-semibold' style={{ textAlign: 'center' }}><b>PRIVACY POLICY</b></h2>
                    <p>Effective date: 2022-05-16</p>
                    <p>1. <b>Introduction</b></p>
                    <p>Welcome to <b> Mohd Usman</b>.</p>
                    <p><b>Mohd Usman</b> operates <b>{process.env.WEBSITE_NAME}</b> (hereinafter referred to as <b>“Service”</b>).</p>
                    <p>Our Privacy Policy governs your visit to <b>{process.env.WEBSITE_NAME}</b>, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
                    ...
                    <p><b>SERVICE</b> means the {process.env.WEBSITE_NAME} website operated by Mohd Usman.</p>
                    ...
                    <p>Mohd Usman uses the collected data for various purposes:</p>
                    ...
                    <p>Mohd Usman will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
                    ...
                    <p> If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <b>{process.env.WEBSITE_EMAIL}</b>.</p>
                    ...
                    <p>0.4. users are able to change their personal information by emailing us at <b>{process.env.WEBSITE_EMAIL}</b>.</p>
                    ...
                    <p>To exercise your California data protection rights described above, please send your request(s) by email: <b>{process.env.WEBSITE_EMAIL}</b>.</p>
                    ...
                    <p>If you have any questions about this Privacy Policy, please contact us by email: <b>{process.env.WEBSITE_EMAIL}</b>.</p>
                </div>
